...
enum LiveCashTheme {
    ...
    static let accentSoft = Color(red: 0.12, green: 0.72, blue: 0.52).opacity(0.15)
    static let income = Color(red: 0.18, green: 0.78, blue: 0.45)
    static let expense = Color(red: 0.95, green: 0.35, blue: 0.38)
